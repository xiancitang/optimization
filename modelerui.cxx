...
inline void ModelerUserInterface::cb_SaveCost_i(Fl_Menu_* o, void* v) {
	char *filename = NULL;
	filename = fl_file_chooser("Save .pos File", "*.txt", NULL);

	
	if (filename)
	{
		FILE* m_costFile = fopen(filename, "w");

		fprintf(m_costFile, "%s, %s, %s, %s \n", "dist", "rot", "total", "best");
		
		fclose(m_costFile);
	}
}
void ModelerUserInterface::cb_SaveCost(Fl_Menu_* o, void* v) {
	((ModelerUserInterface*)(o->parent()->user_data()))->cb_SaveCost_i(o, v);
}
...
inline void ModelerUserInterface::cb_Focus_i(Fl_Menu_*, void*) {
	m_modelerView->m_camera->setLookAt(Vec3f(20, 25, 20));
	m_modelerView->m_camera->setDolly(-60.0f);
	m_modelerView->m_camera->setAzimuth((float)M_PI);
	m_modelerView->m_camera->setElevation(1.5f);
...
// Callback function to look at origin again.
inline void ModelerUserInterface::cb_CamView1_i(Fl_Menu_*, void*) {
	m_modelerView->m_camera->setLookAt(Vec3f(10.3, 12.2, 30.5));
	m_modelerView->m_camera->setDolly(-37.0);
	m_modelerView->m_camera->setAzimuth(3.15f);
	m_modelerView->m_camera->setElevation(6.4f);
	
	m_modelerView->redraw();
}
void ModelerUserInterface::cb_CamView1(Fl_Menu_* o, void* v) {
	((ModelerUserInterface*)(o->parent()->user_data()))->cb_CamView1_i(o, v);
}


// optimize button, once click will start optimization
inline void ModelerUserInterface::cb_m_controlsStartAlgoMenu_i(Fl_Menu_*, void*) {

	ModelerApplication::Instance()->m_startMCMC = (ModelerApplication::Instance()->m_startMCMC) ? false : true; //update ui

	if (ModelerApplication::Instance()->m_startMCMC) ModelerApplication::Instance()->MCMC_Start();
	
	m_modelerView->redraw();
	
	ModelerApplication::Instance()->m_startMCMC = false;

}
void ModelerUserInterface::cb_m_controlsStartAlgorOnMenu(Fl_Menu_* o, void* v) {
  ((ModelerUserInterface*)(o->parent()->user_data()))->cb_m_controlsStartAlgoMenu_i(o,v);
}

// if this checkbox checked and optimization button pressed, it will show intermediate result during optimization
inline void ModelerUserInterface::cb_m_controlsShowUpdate_i(Fl_Menu_*, void*) {

	ModelerApplication::Instance()->m_updateMCMC = (m_controlsUpdateMenu->value()==0) ? false : true;
}

void ModelerUserInterface::cb_m_controlsShowUpdate(Fl_Menu_* o, void* v) {
	((ModelerUserInterface*)(o->parent()->user_data()))->cb_m_controlsShowUpdate_i(o, v);
}



// random reset furnitures position
inline void ModelerUserInterface::cb_m_controlsResetPosition_i(Fl_Menu_*, void*) {

	ModelerApplication::Instance()->m_reset = (ModelerApplication::Instance()->m_reset) ? false : true;
	if (ModelerApplication::Instance()->m_reset) ModelerApplication::Instance()->Init_Poistion();
	m_modelerView->redraw();
	ModelerApplication::Instance()->m_reset = false;

}
void ModelerUserInterface::cb_m_controlsResetPosition(Fl_Menu_* o, void* v) {
	((ModelerUserInterface*)(o->parent()->user_data()))->cb_m_controlsResetPosition_i(o, v);
}
...
Fl_Menu_Item ModelerUserInterface::menu_m_controlsMenuBar[] = {
 ...
 {"Save Cost Value", 0, (Fl_Callback*)ModelerUserInterface::cb_SaveCost, 0, 128, 0, 0, 14, 0 },
...
{ "View 1", 0,  (Fl_Callback*)ModelerUserInterface::cb_CamView1, 0, 0, 0, 0, 14, 0 },
 {0},
 {"MCMC", 0,  0, 0, 64, 0, 0, 14, 0},
 {"Start", 0,  (Fl_Callback*)ModelerUserInterface::cb_m_controlsStartAlgorOnMenu, 0, 0, 0, 0, 14, 0},
  {"ShowUpdate", 0,  (Fl_Callback*)ModelerUserInterface::cb_m_controlsShowUpdate, 0, 2, 0, 0, 14, 0},
 {0},
  {"Reset", 0,  0, 0, 64, 0, 0, 14, 0},
 {"Start", 0,  (Fl_Callback*)ModelerUserInterface::cb_m_controlsResetPosition, 0, 0, 0, 0, 14, 0},
 {0},
 {0}
};
// 11-01-2001: fixed bug that caused animation problems; only if this is a checkbox
Fl_Menu_Item* ModelerUserInterface::m_controlsStartAlgoOnMenu = ModelerUserInterface::menu_m_controlsMenuBar + 20;

Fl_Menu_Item* ModelerUserInterface::m_controlsUpdateMenu = ModelerUserInterface::menu_m_controlsMenuBar + 21;

Fl_Menu_Item* ModelerUserInterface::m_controlsResetPosition = ModelerUserInterface::menu_m_controlsMenuBar + 24;
...
ModelerUserInterface::ModelerUserInterface() {
  Fl_Window* w;
  { Fl_Window* o = m_controlsWindow = new Fl_Window(500, 326, "Modeler");
    w = o;
    o->callback((Fl_Callback*)cb_m_controlsWindow, (void*)(this));
    o->when(FL_WHEN_NEVER);
    { Fl_Menu_Bar* o = m_controlsMenuBar = new Fl_Menu_Bar(0, 0, 500, 25);
      o->menu(menu_m_controlsMenuBar);
    }
    {
	Fl_Browser* o = m_controlsBrowser = new Fl_Browser(0, 25, 200, 300, "Controls");
      o->type(3);
      o->textsize(10);
      o->callback((Fl_Callback*)cb_m_controlsBrowser);
      Fl_Group::current()->resizable(o);
    }
    { Fl_Scroll* o = m_controlsScroll = new Fl_Scroll(205, 25, 290, 300);
      o->type(6);
      o->when(FL_WHEN_CHANGED);
      { Fl_Pack* o = m_controlsPack = new Fl_Pack(205, 25, 270, 300);
        o->end();
      }
      o->end();
    }
  ...
  { Fl_Window* o = m_modelerWindow = new Fl_Window(340*2, 296*2, "Model");
    w = o;
