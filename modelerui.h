...
private:
  ...
  inline void cb_SaveCost_i(Fl_Menu_*, void*);
  static void cb_SaveCost(Fl_Menu_*, void*);
...
private:
  ...
  inline void cb_CamView1_i(Fl_Menu_*, void*);
  static void cb_CamView1(Fl_Menu_*, void*);

public:
	static Fl_Menu_Item *m_controlsStartAlgoOnMenu;
 
private:
  inline void cb_m_controlsStartAlgoMenu_i(Fl_Menu_*, void*);
  static void cb_m_controlsStartAlgorOnMenu(Fl_Menu_*, void*);

public:
	static Fl_Menu_Item *m_controlsUpdateMenu;
	  
private:
	inline void cb_m_controlsShowUpdate_i(Fl_Menu_*, void*);
	static void cb_m_controlsShowUpdate(Fl_Menu_*, void*);

public:
	static Fl_Menu_Item *m_controlsResetPosition;
private:
	inline void cb_m_controlsResetPosition_i(Fl_Menu_*, void*);
	static void cb_m_controlsResetPosition(Fl_Menu_*, void*);
